package com.example.grooveix.services
...
import com.example.grooveix.util.PlayPauseStateNotifier
import com.example.grooveix.util.SeekCompletionNotifier
import com.example.grooveix.util.SharedPreferenceUtil
import com.example.grooveix.util.SongChangeNotifier
import com.example.grooveix.R
import com.example.grooveix.model.Song
import com.example.grooveix.receivers.NotificationActionBroadcastReceiver
import com.zakariya.mzmusicplayer.services.MediaSessionCallback
import com.example.grooveix.ui.activity.MainActivity
import com.example.grooveix.util.Constants.CURRENT_SONG_DURATION_KEY
import com.example.grooveix.util.Constants.NOTIFICATION_CHANNEL_ID
import com.example.grooveix.util.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.grooveix.util.Constants.NOTIFICATION_ID
import com.example.grooveix.util.Constants.POSITION_KEY
import com.example.grooveix.util.Constants.PREF_NAME
import com.example.grooveix.util.PlayerHelper.getSongThumbnail
...
class PlayerService : Service(), MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener,
    ...
    private fun startForegroundService() {
        ...
        val bitmap = if (imgByte != null)
            ...
            BitmapFactory.decodeResource(this.resources, R.drawable.baseline_music_note_24)
        ...
        val builder = androidx.core.app.NotificationCompat
            .Builder(this, NOTIFICATION_CHANNEL_ID).setOngoing(true).apply {
                ...
                setLargeIcon(bitmap)
                setSmallIcon(R.drawable.ic_song_logo_change)
                setShowWhen(false)
